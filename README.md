...
[![Analytics](https://ga-beacon.appspot.com/UA-140657639-1/l5-repository/readme)](https://packagist.org/packages/scolib/l5-repository)
...
#### See versions: [1.0](https://github.com/ScoLib/l5-repository/tree/1.0.4) / [2.0](https://github.com/ScoLib/l5-repository/tree/2.0.14)  / [2.1](https://github.com/ScoLib/l5-repository/tree/2.6.32) 

#### Migrate to: [2.0](migration-to-2.0.md) / [2.1](migration-to-2.1.md) / [3.0](migration-to-3.0.md)
...
```terminal
composer require scolib/l5-repository
```
